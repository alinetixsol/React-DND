    ...
    <Draggable draggableId={todoObj.id.toString()} index={todoObj.id}>
      {(provided) => (
        <div
          ...
          className="todo bg-red-500 shadow-sm rounded grid grid-cols-2 py-5 px-2 my-3 cursor-pointer hover:shadow-lg hover:scale-105 transition-all ease duration-500"
        >

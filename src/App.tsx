...
const App: React.FC = () => {
  ...
  const markTodoDone = (id: number) => {
    const updatedTodos = todos.map((todo) =>
      todo.id === id
        ? { ...todo, type: todo.type === "DONE" ? "LIST" : "DONE" }
        : todo
    );
        ...
        >
          <form onSubmit={onAddNewTodo} className="h-full w-full">
            ...
            <button
              ...
              className={`${
                error && "bg-red-500"
              } z-30 absolute top-[50%] translate-y-[-50%] right-[1px] h-[45px] w-[45px] rounded-full bg-red-600 text-white`}
            >
              ADD
            </button>
          </form>
        ...
        <div className="grid md:grid-cols-2  grid-cols-1 max-w-screen-xl mx-auto w-full gap-4">
          ...
          <Droppable droppableId="TODOLIST">
            {(provided) => (
              ...
              >
                <div className="text-black text-sm font-bold">TODOS LIST</div>
          ...
          <Droppable droppableId="DONELIST">
            {(provided) => (
              <div
                ...
                className="p-2 rounded bg-light w-full h-max"
              >
                <div className="text-black text-sm font-bold">TODOS DONE</div>
                <div className="wrapper">
                  {todos
